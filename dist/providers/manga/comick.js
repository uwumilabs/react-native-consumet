    ...
    constructor() {
        ...
        this.fetchMangaInfo = (mangaId) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const allChapters = yield this.fetchAllChapters(mangaId, 1);
        ...
        this.search = (query_1, ...args_1) => __awaiter(this, [query_1, ...args_1], void 0, function* (query, page = 1, limit = 20) {
            ...
            try {
                const req = yield this._axios().get(`/v1.0/search?q=${encodeURIComponent(query)}&limit=${limit}&page=${page}`);
                const results = {
                    currentPage: page,
                    results: [],
                };
        ...
        this.fetchAllChapters = (mangaId, page) => __awaiter(this, void 0, void 0, function* () {
            if (page <= 0) {
                page = 1;
            }
            const comicId = yield this.getComicId(mangaId);
            const req = yield this._axios().get(`/comic/${comicId}/chapters?page=${page}`);
