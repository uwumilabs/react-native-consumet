            ...
            try {
                ...
                $('div.container > section.block_area > div.block_area-content > div.film_list-wrap > div.flw-item').each((i, el) => {
                    recommendationsArray.push({
                        ...
                        type: $(el).find('div.film-detail > div.fd-infor > span.fdi-item').eq(1).text().trim().toLowerCase() === 'tv'
                            ? TvType.TVSERIES
                            : (TvType.MOVIE ?? null),
                    });
                });
                ...
                movieInfo.releaseDate = $('div.row > div.col-xl-5 .row-line').eq(0).text().replace('Released: ', '').trim();
