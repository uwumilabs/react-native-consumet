...
class DramaCool extends models_1.MovieParser {
    constructor() {
        ...
        this.search = (query_1, ...args_1) => __awaiter(this, [query_1, ...args_1], void 0, function* (query, page = 1) {
            try {
                ...
                const { data } = yield axios_1.default.get(`${this.baseUrl}/search?type=drama&keyword=${query.replace(/[\W_]+/g, '+')}&page=${page}`);
        ...
        this.fetchEpisodeSources = (episodeId_1, ...args_1) => __awaiter(this, [episodeId_1, ...args_1], void 0, function* (episodeId, server = models_1.StreamingServers.AsianLoad) {
            if (episodeId.startsWith('http')) {
                const serverUrl = new URL(episodeId);
                switch (server) {
                    case models_1.StreamingServers.AsianLoad:
                        return Object.assign(Object.assign({ headers: { Referer: serverUrl.origin } }, (yield new extractors_1.AsianLoad().extract(serverUrl))), { download: this.downloadLink(episodeId) });
                    ...
                    case models_1.StreamingServers.StreamWish:
                        return Object.assign({ headers: { Referer: serverUrl.origin } }, (yield new extractors_1.StreamWish().extract(serverUrl)));
        ...
        this.fetchRecentTvShows = (...args_1) => __awaiter(this, [...args_1], void 0, function* (page = 1) {
            return this.fetchData(`${this.baseUrl}/all-recently-added/drama?page=${page}`, page, true);
        });
        this.fetchRecentMovies = (...args_1) => __awaiter(this, [...args_1], void 0, function* (page = 1) {
            return this.fetchData(`${this.baseUrl}/all-recently-added/movie?page=${page}`, page, false, true);
        });
        this.fetchSpotlight = () => __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    fetchEpisodeServers(episodeId, ...args) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const url = standardServer.startsWith('//') ? standardServer === null || standardServer === void 0 ? void 0 : standardServer.replace('//', 'https://') : standardServer;
                const { data: servers } = yield axios_1.default.get(url);
    ...
    fetchData(url_1, page_1) {
        return __awaiter(this, arguments, void 0, function* (url, page, isTvShow = false, isMovies = false) {
            try {
