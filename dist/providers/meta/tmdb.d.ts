import { type ISearch, type IAnimeInfo, type IAnimeResult, type ISource, type IEpisodeServer, MovieParser, TvType, type IMovieResult, type IMovieInfo, type ProxyConfig } from '../../models';
