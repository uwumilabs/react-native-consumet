...
function createZoro(ctx) {
    ...
    class ZoroImpl extends AnimeParser {
        constructor(customBaseURL) {
             ...
             */
            this.fetchEpisodeSources = (episodeId_1, ...args_1) => __awaiter(this, [episodeId_1, ...args_1], void 0, function* (episodeId, server = StreamingServersEnum.VidCloud, subOrDub = SubOrSubEnum.SUB) {
                ...
                try {
                    ...
                    return yield this.fetchEpisodeSources(link, server, SubOrSubEnum.SUB);
                }
                catch (err) {
                    throw err;
                }
