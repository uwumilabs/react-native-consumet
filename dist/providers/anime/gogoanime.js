...
import { AnimeParser, StreamingServers, MediaStatus, SubOrSub, MediaFormat, } from '../../models';
...
class Gogoanime extends AnimeParser {
    constructor(customBaseURL, proxy, adapter) {
         ...
         */
        this.fetchEpisodeSources = async (episodeId, server = StreamingServers.VidStreaming, downloadUrl = undefined) => {
