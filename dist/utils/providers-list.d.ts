...
export declare const PROVIDERS_LIST: {
    ANIME: (import("../providers/anime/gogoanime").default | import("../providers/anime/animepahe").default | import("../providers/anime/zoro").default | import("../providers/anime/animefox").default | import("../providers/anime/anify").default | import("../providers/anime/bilibili").default | import("../providers/anime/marin").default | import("../providers/anime/animekai").default | import("../providers/anime/animeowl").default)[];
    ...
    MOVIES: (import("../providers/movies/dramacool").default | import("../providers/movies/flixhq").default | import("../providers/movies/fmovies").default | import("../providers/movies/goku").default | import("../providers/movies/kissasian").default | import("../providers/movies/moviehdwatch").default | import("../providers/movies/viewAsian").default | import("../providers/movies/sflix").default | import("../providers/movies/multimovies").default | import("../providers/movies/netflixmirror").default | import("../providers/movies/himovies").default)[];
...
//# sourceMappingURL=providers-list.d.ts.map