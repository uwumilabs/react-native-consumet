...
export declare const PROVIDERS_LIST: {
    ANIME: (import("../providers/anime/animepahe/animepahe").AnimePahe | import("../providers/anime/zoro/zoro").Zoro | import("../providers/anime/anify").default | import("../providers/anime/marin").default | import("../providers/anime/animekai").default)[];
