...
// // Use the global crypto API that should be provided by the polyfill
// const crypto =
...
//   return (memoryBuff =
//     memoryBuff !== null && memoryBuff.byteLength !== 0
//       ? memoryBuff
...
//   return typeof Response === 'function' && isResponse(QP)
