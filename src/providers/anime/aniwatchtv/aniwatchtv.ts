...
import createAniWatchTv, { type AniWatchTvProviderInstance } from './create-aniwatchtv';

// Backward compatibility wrapper class
export class AniWatchTv extends AnimeParser {
  private instance: AniWatchTvProviderInstance;
  ...
  constructor(customBaseURL?: string) {
    ...
    this.instance = createAniWatchTv(defaultContext, customBaseURL);
