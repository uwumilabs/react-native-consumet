...
async function getSources(embed_url, site) {
  // const embed_url = "https://megacloud.tv/embed-2/e-1/"+xrax+"?k=1"
  let xrax = embed_url
    .split("/")
    .pop()
    ?.split("?")
  ...
  await getMeta(embed_url.includes("mega") ? "https://megacloud.tv/" + test[3] + "/" + test[4] + "/" + test[5] : embed_url, site)
  ...
  try {
    await V(base_url.includes("mega") ? "https://megacloud.tv/images/loading.png?v=0.0.9" : base_url+"/images/loading.png?v=0.0.9")
    let getSourcesUrl = ""
